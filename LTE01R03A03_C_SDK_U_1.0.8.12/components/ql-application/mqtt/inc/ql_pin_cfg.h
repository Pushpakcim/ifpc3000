...
// DO config CIM
#define QL_TEST1_PIN_GPIO1                  QUEC_PIN_DNAME_SIM_2_CLK
#define QL_TEST1_PIN_GPIO1_FUNC_GPIO        2
#define QL_TEST1_PIN_GPIO1_FUNC_SIM_2_CLK   0
#define QL_TEST1_PIN_GPIO2                  QUEC_PIN_DNAME_SIM_2_DIO
#define QL_TEST1_PIN_GPIO2_FUNC_GPIO        2
#define QL_TEST1_PIN_GPIO2_FUNC_SIM_2_DIO   0
#define QL_TEST1_PIN_GPIO3                  QUEC_PIN_DNAME_GPIO_8
#define QL_TEST1_PIN_GPIO3_FUNC_GPIO        0

// DI config CIM
#define QL_TEST1_PIN_GPIO6                  QUEC_PIN_DNAME_SPI_CAMERA_SI_1
#define QL_TEST1_PIN_GPIO6_FUNC_GPIO        4
#define QL_TEST1_PIN_GPIO23                 QUEC_PIN_DNAME_SPI_CAMERA_SCK
#define QL_TEST1_PIN_GPIO23_FUNC_GPIO       4
#define QL_TEST1_PIN_GPIO24                 QUEC_PIN_DNAME_GPIO_2
#define QL_TEST1_PIN_GPIO24_FUNC_GPIO       0
#define QL_TEST1_PIN_GPIO25                 QUEC_PIN_DNAME_GPIO_3
#define QL_TEST1_PIN_GPIO25_FUNC_GPIO       0
#define QL_TEST1_PIN_GPIO26                 QUEC_PIN_DNAME_GPIO_1
#define QL_TEST1_PIN_GPIO26_FUNC_GPIO       0
#define QL_TEST1_PIN_GPIO27                 QUEC_PIN_DNAME_GPIO_0
#define QL_TEST1_PIN_GPIO27_FUNC_GPIO       0

// LED config CIM
#define QL_TEST1_PIN_GPIO65                 QUEC_PIN_DNAME_GPIO_18
#define QL_TEST1_PIN_GPIO65_FUNC_GPIO       0
#define QL_TEST1_PIN_GPIO66                 QUEC_PIN_DNAME_SPI_CAMERA_SI_0
#define QL_TEST1_PIN_GPIO66_FUNC_GPIO       4

// Switch PIN config CIM
#define QL_TEST1_PIN_GPIO28                     QUEC_PIN_DNAME_SDMMC1_DATA_3
#define QL_TEST1_PIN_GPIO28_FUNC_GPIO           1
#define QL_TEST1_PIN_GPIO28_FUNC_SDMMC1_DATA_3  0
#define QL_TEST1_PIN_GPIO29                     QUEC_PIN_DNAME_SDMMC1_DATA_2
#define QL_TEST1_PIN_GPIO29_FUNC_GPIO           1
#define QL_TEST1_PIN_GPIO29_FUNC_SDMMC1_DATA_2  0
#define QL_TEST1_PIN_GPIO30                     QUEC_PIN_DNAME_SDMMC1_DATA_1
#define QL_TEST1_PIN_GPIO30_FUNC_GPIO           1
#define QL_TEST1_PIN_GPIO30_FUNC_SDMMC1_DATA_1  0
#define QL_TEST1_PIN_GPIO31                     QUEC_PIN_DNAME_SDMMC1_DATA_0
#define QL_TEST1_PIN_GPIO31_FUNC_GPIO           1
#define QL_TEST1_PIN_GPIO31_FUNC_SDMMC1_DATA_0  0
...
//for rs485 demo
#define QL_RS485_PIN_GPIO                   QUEC_PIN_DNAME_GPIO_19//QUEC_PIN_DNAME_SDMMC1_DATA_1
#define QL_RS485_PIN_GPIO_FUNC_GPIO         0
#define QL_RS485_GPIO_NUM                   GPIO_19 //GPIO_26
