...
#define HTTP_DLOAD_URL                      "http://fota.hacperme.com/xyz123/output.pack" //"http://49.235.127.120/output.pack"
...
static int fota_http_evn_request(fota_http_client_t* fota_http_cli_p)
{
	...
	ql_httpc_setopt(&(fota_http_cli_p->http_cli), HTTP_CLIENT_OPT_URL, mBinPath);
	//设置sim_id
