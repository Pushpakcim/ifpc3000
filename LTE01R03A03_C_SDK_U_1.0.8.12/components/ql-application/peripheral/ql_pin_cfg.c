...
/*SLEEP_IND  */{  3  ,        0,              0,        GPIO_8,    GPIO_OUTPUT,      QUEC_PIN_NONE,         LVL_LOW },  // check 
...
#else
/*WAKEUP_IN  */{  1  ,        2,              2,        GPIO_29,   GPIO_OUTPUT,       QUEC_PIN_NONE,        LVL_LOW },  //check
/*AP_READY   */{  2  ,        2,              2,        GPIO_30,   GPIO_OUTPUT,       QUEC_PIN_NONE,        LVL_LOW },  //check
